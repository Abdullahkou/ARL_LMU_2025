...
def train(
    ...
    for seed in seeds:
        ...
        eval_env = make_gym(env_id, render_mode="rgb_array" if use_rendering else None)
        ...
        if should_record_heads:
            ...
            eval_env_per_head: gym.vector.VectorEnv = make_gym_vec(
        ...
        if training_config.record_training:
            log_interval = total_steps // train_log_phases
            train_logger = TrainLogger(training_results_file, log_interval=log_interval)
